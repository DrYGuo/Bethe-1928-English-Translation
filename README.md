# Working English Translation — September 2026

**Hans Bethe, "Theorie der Beugung von Elektronen an Kristallen," _Annalen der Physik_ 392, 55–129 (1928).**

This repository contains a working scholarly English translation of Bethe's 1928 paper on the theory of electron diffraction by crystals — the founding work of dynamical electron diffraction theory.
...
- The original 1928 work by Hans Bethe is in the **public domain in the United States**.
- English translation and editorial material **© 2026 Yueming Guo. All rights reserved** pending formal publication.
- No open-source software license (e.g. MIT) is applied to this repository. Licensing terms for the translation will be determined after consultation with _Annalen der Physik_.

## Feedback

Corrections and suggestions are welcome via GitHub Issues. Please reference the original journal page number (55–129) and, where applicable, the equation number.

## Acknowledgments

Translation and audit by Muse Spark 1.3 (Meta), with about ten rounds of audit and cross-check contributed by GPT-5.6 (OpenAI). English prose of the reading edition re-reviewed sentence by sentence by GPT-5.6 (OpenAI).
